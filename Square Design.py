...
def block_3(Turtle, x, y, C1, C2, s):
    design_1(Turtle, x, y-s*8-8,C1, C2, s)
    design_2(Turtle, x+s*4, y-s*8-8, C1, C2, s)
    design_1(Turtle, x+s*8, y-s*8-8, C1, C2, s)

def Final_Design(Turtle, x, y, C1, C2, s):
#This function makes takes the blocks and turns them into the final design
    block_1(Turtle, x, y, C1, C2, s)
    block_2(Turtle, x, y, C1, C2, s)
    block_3(Turtle, x, y, C1, C2, s)
    
##Execution

Final_Design(ted, -475, 400, 'lightgreen', 'lightblue', 30)
